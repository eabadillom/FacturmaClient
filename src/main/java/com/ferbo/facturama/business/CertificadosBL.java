...
public class CertificadosBL extends FacturamaBL {
	...
	public List<CsdRsp> get() throws IOException, FacturamaException {
        List<CsdRsp> beans = null;
        String sURL = null;
        ...
        try {
            ...
            listType = new TypeToken<ArrayList<CsdRsp>>(){}.getType();
	...
	public void registra(Csd certificado) throws FacturamaException {
        String sURL = null;
        ...
        try {
            ...
            jsonRequest = prettyGson.toJson(certificado);
	...
	public void elimina(String rfc) throws FacturamaException {
        String sURL = null;
        ...
        try {
            ...
            sURL = basePath + "/api-lite/csds/%s";
            sURL = String.format(sURL, rfc);
            ...
            log.info("El certificado asociado al RFC {} se eliminó correctamente en facturama.", rfc);
        } catch(FacturamaInternalException ex) {
        	log.error("Se presentó un problema en la comunicación con Facturama...", ex);
        	String message = this.getErrorMessage(response);
            throw new FacturamaException(message);
