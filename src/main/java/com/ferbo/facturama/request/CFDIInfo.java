...
s     */
    ...
    /**Entidad Fiscal que emite el CFDI<br>
     * Required (sólo para api-lite
     */
    @SerializedName(value = "Issuer")
    private IssuerBindingModel issuer = null;
    
    /**ClientModel a quien se emitirá el CFDi, Atributo Requerido<br>
     * Required
     */
	...
	public IssuerBindingModel getIssuer() {
		return issuer;
	}

	public void setIssuer(IssuerBindingModel issuer) {
		this.issuer = issuer;
	}
}
